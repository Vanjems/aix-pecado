    ...
    <main id="hero" className="relative w-full min-h-screen flex justify-center overflow-hidden pt-16 md:pt-20 lg:pt-25">
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 md:gap-6 lg:gap-8 px-4">
        ...
        <div className="flex flex-col md:flex-row gap-2 md:gap-3 lg:gap-4">
          {/* Launch App Button */}
          <button
            className="px-4 py-2 md:px-6 md:py-2.5 lg:px-8 lg:py-3 rounded-full font-bold text-sm md:text-base lg:text-lg text-black font-quicksand transition-opacity hover:opacity-90 cursor-pointer bg-[#E0E0E0]"
          >
            Launch App
          </button>
          ...
          {/* Learn More Button */}
          <button
            className="px-4 py-2 md:px-6 md:py-2.5 lg:px-8 lg:py-3 rounded-full font-bold text-sm md:text-base lg:text-lg text-white font-quicksand transition-opacity hover:opacity-90 cursor-pointer bg-black/50"
          >
            Learn More
          </button>
        </div>
